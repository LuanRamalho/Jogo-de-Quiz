...
questions = ["Qual é o maior país do mundo em extensão territorial?",
             "Quantos dias tem um ano bissexto?",
             "Qual destes quatro pássaros tem o bico e os pés mais compridos?",
             "Qual é a moeda nacional dos Estados Unidos da América (EUA)?",
             "Guido van Rossum em 1991 projetou qual linguagem?",
             "Termine a sequência: 9, 18, 27, _?",
             "Qual componente do computador é responsável pela execução de arquivos e processamento de dados?",
             "Qual animal é chamado de rei da selva?",
             "Que horas correspondem a 23:23 horas?",
             "Qual componente do computador é responsável pelo fornecimento de energia elétrica?",
             "Qual é o maior planeta do nosso sistema solar?",
             "Quantos continentes existem no mundo?",
             "Quantos anos há em um milênio?",
             "iPad é fabricado por?",
             "Quem fundou a Microsoft?"]

first_option = ["Índia", "354",
                "Garça", "Euro",
                "Javascript", "36",
                "Monitor", "Elefante", "11:23PM", "HD",
                "Terra", "8",
                "100 anos", "Google", "Monty Ritz"]

second_option = ["EUA", "366",
                 "Papagaio", "Peso ",
                 "Python", "34",
                 "Placa-Mãe", "Leão", "11.11PM", "Processador",
                 "Urano", "5",
                 "50 anos",
                 "Microsoft", "Danis Lio"]
...
third_option = ["China", "365",
                "Corvo", "Dólar",
                "Java", "30",
                "Processador", "Tigre", "7:23PM", "Fonte",
                "Marte", "7",
                "500 anos",
                "Amazon", "Bill Gates"]

fourth_option = ["Rússia", "420",
                 "Pombo", "Iene",
                 "C++", "37",
                 "Memória RAM", "Vaca", "9.11PM", "GPU",
                 "Júpiter",
                 "6",
                 "1000 anos", "Apple",
                 "Jeff Bezos"]

correct_answers = ["Rússia", "366", "Garça", "Dólar", "Python", "36",
                   "Processador", "Leão", "11:23PM", "Fonte", "Júpiter", "6", "1000 anos", "Apple",
                   "Bill Gates"]
    ...
    for i in range(15):
        if value == correct_answers[i]:
            if value == third_option[14]:
                ...
                root2.title('Você ganhou 1 milhão de reais')
                centerimg = PhotoImage(file='center.png')
                imgLabel = Label(root2, image=centerimg, bd=0, )
                imgLabel.pack(pady=30)

                winlabel = Label(root2, text='Você Venceu', font=('arial', 40, 'bold'), bg='black', fg='white')
                winlabel.pack()
                ...
                playagainButton = Button(root2, text='Jogar Novamente', font=('arial', 20, 'bold'), bg='black', fg='white',
                                         bd=0
        ...
        if value not in correct_answers:
            ...
            imgLabel.pack(pady=30)
            loselabel = Label(root1, text='Você Perdeu', font=('arial', 40, 'bold'), bg='black', fg='white')
            loselabel.pack()
            ...
            tryagainButton = Button(root1, text='Tente Novamente', font=('arial', 20, 'bold'), bg='black', fg='white', bd=0
                                    , activebackground='black', cursor='hand2', activeforeground='white',
                                    command=tryagain)
            tryagainButton.pack()

            closeButton = Button(root1, text='Fechar', font=('arial', 20, 'bold'), bg='black', fg='white', bd=0
                                 , activebackground='black', cursor='hand2', activeforeground='white',
                                 command=on_closing)
            closeButton.pack()
